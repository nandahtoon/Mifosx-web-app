...
AI-assisted development must remain safe, reviewable, and commercially useful. The goal is high-productivity AI execution with human approval at key decision points.
...
After coding, AI must report files changed, routes affected, APIs used, checks run, known limitations, and screenshots for UI changes.
